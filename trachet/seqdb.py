...
_SEQDB = {
    ...
    '< ESC P 1+r436f=3136<ST>'         :  'answer for termcap query Co=16',
    '< ESC P 1+r436f=323536<ST>'       :  'answer for termcap query Co=256',
    '< ESC P 1+r6b75=1B4F41 <ST>'      :  'answer for termcap query ku=\eOA',
    '< ESC P 1+r6b64=1B4F42 <ST>'      :  'answer for termcap query kd=\eOB',
    '< ESC P 1+r6b72=1B4F43 <ST>'      :  'answer for termcap query kr=\eOC',
    '< ESC P 1+r6b6c=1B4F44 <ST>'      :  'answer for termcap query kl=\eOD',
    '< ESC P 1+r2332=1B5B313B3248 <ST>':  'answer for termcap query #2=\e[1;2H',
    '< ESC P 1+r2334=1B5B313B3244 <ST>':  'answer for termcap query #4=\e[1;2D',
    '< ESC P 1+r2569=1B5B313B3243 <ST>':  'answer for termcap query %i=\e[1;2C',
    '< ESC P 1+r2a37=1B5B313B3246 <ST>':  'answer for termcap query *7=\e[1;2F',
    '< ESC P 1+r6b31=1B4F50 <ST>'      :  'answer for termcap query k1=\eOP',
    '< ESC P 1+r6b32=1B4F51 <ST>'      :  'answer for termcap query k2=\eOQ',
    '< ESC P 1+r6b33=1B4F52 <ST>'      :  'answer for termcap query k3=\eOR',
    '< ESC P 1+r6b34=1B4F53 <ST>'      :  'answer for termcap query k4=\eOS',
    '< ESC P 1+r6b35=1B5B31357E <ST>'  :  'answer for termcap query k5=\e[15~',
    '< ESC P 1+r6b36=1B5B31377E <ST>'  :  'answer for termcap query k6=\e[17~',
    '< ESC P 1+r6b37=1B5B31387E <ST>'  :  'answer for termcap query k7=\e[18~',
    '< ESC P 1+r6b38=1B5B31397E <ST>'  :  'answer for termcap query k8=\e[19~',
    '< ESC P 1+r6b39=1B5B32307E <ST>'  :  'answer for termcap query k9=\e[20~',
    '< ESC P 1+r6b3b=1B5B32317E <ST>'  :  'answer for termcap query k;=\e[21~',
    '< ESC P 1+r4631=1B5B32337E <ST>'  :  'answer for termcap query F1=\e[23~',
    '< ESC P 1+r4632=1B5B32347E <ST>'  :  'answer for termcap query F2=\e[24~',
    '< ESC P 1+r2531=1B5B32387E <ST>'  :  'answer for termcap query %1=\e[28~',
    '< ESC P 1+r2638= <ST>'            :  'answer for termcap query &8=',
    '< ESC P 1+r6b62=08 <ST>'          :  'answer for termcap query kb=^H',
    '< ESC P 1+r6b49=1B5B327E <ST>'    :  'answer for termcap query kI=\e[2~',
    '< ESC P 1+r6b44=1B5B337E <ST>'    :  'answer for termcap query kD=\e[3~',
    '< ESC P 1+r6b68=1B4F48 <ST>'      :  'answer for termcap query kh=\eOH',
    '< ESC P 1+r4037=1B4F46 <ST>'      :  'answer for termcap query @7=\eOF',
    '< ESC P 1+r6b50=1B5B357E <ST>'    :  'answer for termcap query kP=\e[5~',
    '< ESC P 1+r6b4e=1B5B367E <ST>'    :  'answer for termcap query kN=\e[6~',
    '< ESC P 1+r4b31=1B4F48 <ST>'      :  'answer for termcap query K1=\eO8',
    '< ESC P 1+r4b33=1B5B357E <ST>'    :  'answer for termcap query K3=\e[5~',
    '< ESC P 1+r4b34=1B4F46 <ST>'      :  'answer for termcap query K4=\eOF',
    '< ESC P 1+r4b35=1B5B367E <ST>'    :  'answer for termcap query K5=\e[6~',
    '< ESC P 1+r6b42=1B5B5A <ST>'      :  'answer for termcap query kB=\e[Z',
