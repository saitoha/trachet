...
_SEQDB = {
    ...
    'DA1 Response: VT500 family (could be RLogin)',
    '< CSI >c'           : 'DA2 Response',
    '< CSI >0;[2]c'      : 'DA2 Response: VT100, Pv=%d, keyboard type=%d',
    ...
    '< CSI >1;[2]c'      : 'DA2 Response: VT220, Pv=%d, keyboard type=%d',
    ...
    '< CSI >2;[2]c'      : 'DA2 Response: VT240, Pv=%d, keyboard type=%d',
    '< CSI >18;[2]c'     : 'DA2 Response: VT330, Pv=%d, keyboard type=%d',
    '< CSI >19;[2]c'     : 'DA2 Response: VT340, Pv=%d, keyboard type=%d',
    '< CSI >19;[2]c'     : 'DA2 Response: VT340, Pv=%d, keyboard type=%d',
    '< CSI >24;[2]c'     : 'DA2 Response: VT320, Pv=%d, keyboard type=%d',
    '< CSI >32;[2]c'     : 'DA2 Response: VT382, Pv=%d, keyboard type=%d',
    '< CSI >32;100;2c'   : 'DA2 Response: VT382 (could be TeraTerm)',
    '< CSI >41;[2]c'     : 'DA2 Response: VT420, Pv=%d, keyboard type=%d',
    ...
    '< CSI >61;[2]c'     : 'DA2 Response: VT510, Pv=%d, keyboard type=%d',
    '< CSI >64;[2]c'     : 'DA2 Response: VT520, Pv=%d, keyboard type=%d',
    '< CSI >65;[2]c'     : 'DA2 Response: VT525, Pv=%d, keyboard type=%d',
    '< CSI >65;100;1c'   : 'DA1 Response: VT500 family (could be RLogin)',
    '< CSI >77;[2]c'     : 'DA2 Response: could be MinTTY, Pv=%d, keyboard type=%d',
    '< CSI >77;[1];c'    : 'DA2 Response: could be MinTTY, Pv=%d',
    ...
    '< CSI >82;[2]c'     : 'DA2 Response: could be mrxvt, Pv=%d, keyboard type=%d',
    '< CSI >82;20710;0c' : 'DA2 Response: could be rxvt/ck',
    '< CSI >82;0.5.4;0c' : 'DA2 Response: could be mrxvt 0.5.4',
    '< CSI >83;[2]c'     : 'DA2 Response: could be GNU Screen, Pv=%d, keyboard type=%d',
    ...
    '< CSI 3;[2]t'       : 'CSI 13 t Response: window position (x, y) is (%d, %d)',
    '< CSI 4;[2]t'       : 'CSI 14 t Response: window size (height, width) in pixels is (%d, %d)',
    '< CSI 8;[2]t'       : 'CSI 18 t Response: text area size (height, width) in characters is (%d, %d)',
    '< CSI 9;[2]t'       : 'CSI 19 t Response: screen size (height, width) in characters is (%d, %d)',
    ...
    '> CSI ?66h'         : 'DECSET 66 - DECNKM / application keypad',
    ...
    '> CSI ?7727h'       : 'DECSET 7727 / application escape keycode mode (MinTTY)',
    ...
    '> CSI ?66l'         : 'DECRST 66 - DECNKM / numeric keypad',
    ...
    '> CSI [1]t'         : 'DECSLPP / Resize to %d lines',
    ...
    '> CSI [5]$t'        : 'DECRARA / reverse attributes in rectangular area - top=%d, left=%d, bottom=%d, right=%d, attribute=%d',
    ...
    '> CSI [1]<SP>t'     : 'DECSWBV / set warning bell volume to %d',
    '> CSI u'            : 'Restore cursor (ANSI.SYS)',
    '> CSI <SP>u'        : 'DECSMBV / set margin bell volume',
    '> CSI [1]<SP>u'     : 'DECSMBV / set margin bell volume to %d',
